package com.ztax.gateway.redis.utils;

import com.ztax.gateway.utils.ObjectUtils;
...
public class RedisUtils {
    ...
    public boolean expire(String key, long time) {
        try {
            ...
            logger.error("expire key exception:", e);
            return false;
        }
    }
    ...
    public boolean hasKey(String key) {
        try {
            ...
            logger.error("ops redis exception:", e);
            return false;
        }
    }
    ...
    private final static String LOCK_PREFIX = "com:ztax:";

    private final static long LOCK_EXPIRE = 2000;
